# Ввести с клавиатуры фразу на русском языке. Перевесим ее на
# транслит и вывести на экран. 
# Например "Я обожаю программировать на Турбо Паскале!"-
# "Ya obozhayu programmirovat' na Turbo Paskale!"
